...
#define COB_BLD_BUILD "none-none-none"

/* informational: compiler during compilation */
#define COB_BLD_CC "/root/code/emsdk/upstream/emscripten/emcc"
...
#define COB_BLD_CPPFLAGS "-I/root/code/webassembly/cobol-wasm/dist/emscripten/include"

/* informational: linker during compilation */
#define COB_BLD_LD "/root/code/emsdk/upstream/emscripten/emcc"

/* informational: linker flags during compilation */
#define COB_BLD_LDFLAGS "-L/root/code/webassembly/cobol-wasm/dist/emscripten/lib -Wl,-z,relro,-z,now,-O1"

/* compiler used by cobc */
#define COB_CC "/root/code/emsdk/upstream/emscripten/emcc"

/* compiler flags passed to compiler by cobc */
#define COB_CFLAGS "-pipe -I/root/code/webassembly/cobol-wasm/dist/emscripten/include -I/root/code/webassembly/cobol-wasm/dist/emscripten/include -Wno-unused -fsigned-char -Wno-pointer-sign -Qunused-arguments -Wno-deprecated-non-prototype"

/* Compilation of computed gotos works */
#define COB_COMPUTED_GOTO 1

/* default search path for copybooks */
#define COB_CONFIG_DIR "/root/code/webassembly/cobol-wasm/dist/emscripten/share/gnucobol/config"

/* default search path for configuration files */
#define COB_COPY_DIR "/root/code/webassembly/cobol-wasm/dist/emscripten/share/gnucobol/copy"

/* Compile/link option for debugging */
#define COB_DEBUG_FLAGS "-g -fasynchronous-unwind-tables"
...
#define COB_LDFLAGS "-L/root/code/webassembly/cobol-wasm/dist/emscripten/lib"

/* default search path for extra modules */
#define COB_LIBRARY_PATH "/root/code/webassembly/cobol-wasm/dist/emscripten/lib/gnucobol"

/* libraries passed to linker by cobc */
#define COB_LIBS "-L/root/code/webassembly/cobol-wasm/dist/emscripten/lib -lcob"
